...
def create_elevation_poi_map():
    ...
    with open(r'C:\Users\yanit\OneDrive\Bureau\Data Insights And Visualization\tsunami\sunda_elevation.json', 'r') as f:
        data = json.load(f)
    ...
    # Set axis limits
    ax.set_xlim(105.796, 105.880)
    ax.set_ylim(-6.420, -6.218)

    # Add title and labels
    plt.title('Sunda Area Elevation Map with Roads and POI Centroids')
